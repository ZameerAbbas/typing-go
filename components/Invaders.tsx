        ...
        <div className="absolute inset-0 pointer-events-none">
          {invaders.map(invader => {
            ...
            return (
              ...
              >
                <div className={`px-3 py-1 rounded font-mono font-bold whitespace-nowrap shadow-xl transition-all ${invader.type === 'boss'
                    ? isMatching
                  ...
                  <span className="inline-flex gap-0.5">
                    {word.split('').map((char, idx) => (
                      <span
                        key={idx}
                        className={`transition-all text-md duration-150 ${idx < matchLength
